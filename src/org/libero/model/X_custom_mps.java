...
/** Generated Model for custom_mps
 *  @author iDempiere (generated) 
 *  @version Release 10 - $Id$ */
@org.adempiere.base.Model(table="custom_mps")
public class X_custom_mps extends PO implements I_custom_mps, I_Persistent 
{
    ...
    public X_custom_mps (Properties ctx, int custom_mps_ID, String trxName)
    {
    ...
    /** Standard Constructor */
    public X_custom_mps (Properties ctx, int custom_mps_ID, String trxName, String ... virtualColumns)
    {
    ...
    /** Load Constructor */
    public X_custom_mps (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_custom_mps[")
	...
	*/
	...
	/** Set custom_mps_UU.
		@param custom_mps_UU custom_mps_UU
	*/
	public void setcustom_mps_UU (String custom_mps_UU)
	{
		set_ValueNoCheck (COLUMNNAME_custom_mps_UU, custom_mps_UU);
	}

	/** Get custom_mps_UU.
		@return custom_mps_UU	  */
	public String getcustom_mps_UU()
	{
		return (String)get_Value(COLUMNNAME_custom_mps_UU);
	}

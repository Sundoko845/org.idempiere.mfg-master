...
public class MFG_ModelFactory implements IModelFactory {
	...
	public PO getPO(String tableName, int Record_ID, String trxName) {
		 if (tableName.equals(MDDNetworkDistribution.Table_Name)) {
		   ...
		   }else if (tableName.equals(MCustomMps.Table_Name)){
			   return new MCustomMps(Env.getCtx(), Record_ID, trxName);
		   }else if (tableName.equals(MCustomMpsMo.Table_Name)){
			   return new MCustomMpsMo(Env.getCtx(), Record_ID, trxName);
		   }else if (tableName.equals(MCustomMpsMaterial.Table_Name)){
			   return new MCustomMpsMaterial(Env.getCtx(), Record_ID, trxName);
		   }
		   return null;
	}
	...
	public PO getPO(String tableName, ResultSet rs, String trxName) {
		 if (tableName.equals(MDDNetworkDistribution.Table_Name)) {
		     return new MDDNetworkDistribution(Env.getCtx(), rs, trxName);
			   ...
			   return new MCustomMps(Env.getCtx(), rs, trxName);
		   }else if (tableName.equals(MCustomMpsMo.Table_Name)){
			   return new MCustomMpsMo(Env.getCtx(), rs, trxName);
		   }else if (tableName.equals(MCustomMpsMaterial.Table_Name)){
			   return new MCustomMpsMaterial(Env.getCtx(), rs, trxName);
		   }
		   return null;
	}
